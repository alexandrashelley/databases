...
INSERT INTO recipes (name, cooking_time, rating) VALUES ('Bang Bang Cauliflower', '60', '4');
INSERT INTO recipes (name, cooking_time, rating) VALUES ('Tofu Rolls', '40' '5');
```
...
recipes.first.id # =>  1
recipes.first.name # =>  'Bang Bang Cauliflower'
recipes.first.cooking_time # =>  '60'
recipes.first.rating # => 4

recipes.last.id # =>  2
recipes.last.name # =>  'Tofu Rolls' 
recipes.last.cooking_time # =>  '40'
recipes.last.rating # => 5

# 2
# Find one recipe for a given id 
