...
INSERT INTO books (title, author_name) VALUES ('Memoirs of a Geisha', 'Arthur Golden');
```
...
books.first.id # =>  1
books.first.title # =>  'The Alchemist'
books.first.author_name # =>  'Paulo Coelho'

books.second.id # =>  2
books.second.title # =>  'Memoirs of a Geisha'
books.second.release_year # =>  'Arthur Golden'
