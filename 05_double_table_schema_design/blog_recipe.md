...
posts, title, post content, comments, comment content, comment author
```
...
```bash
psql -h 127.0.0.1 blog_database < posts_table.sql
psql -h 127.0.0.1 blog_database < comments_table.sql
```
